...
import { updateEmployee } from "../utility/admin-utils/employees.firebase";
        ...
        <div className={styles.Form__Container}>
          <div className={styles.Employees__Form}>
            <div className={styles.Form__Header}>
              ...
              <div className={styles.Header__Top2}>Employee {id}</div>
            </div>
            ...
            <div className={styles.Form__Btn_Container}>
              ...
              <button type="submit" className={styles.Form__Reset_Btn}>
                Reset Password
              </button>
            </div>
          </div>
